...
(defun prove-using-snark-depth-zero (term args)
  (check-type term list)
  (trace-format "~&Trying to prove or refute:~28T~:W~%" term)
  (trace-format "~&    Solution depth:~28T0~%")
...
(defun prove-using-snark-closure (term solution-depth answer-vars)
  (check-type term list)
  (trace-format "~&Trying to prove:~28T~:W" term)
  (trace-format "~&    Solution depth:~28T~A~%" solution-depth)
